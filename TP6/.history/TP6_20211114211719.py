...
def analysis_question3(model_name,gpu=False):
    ...
    for filename in sorted(os.listdir(BNC_folder)):
        ...
        with open(BNC_folder + filename, 'r', encoding="utf8") as f:
            ...
            for s in tqdm(sentences):
                ...
                if i%1000==0 : pd.DataFrame(all_tuples, columns=['subject_lemma', 'verb_lemma', 'object_lemma']).to_csv(f'nb_triplet_{model_name[11:]}_1.csv',encoding='utf-8',index=False)
    ...
    pd.DataFrame(all_tuples, columns=['subject_lemma', 'verb_lemma', 'object_lemma']).to_csv(f'nb_triplet_{model_name[11:]}_1.csv',encoding='utf-8',index=False)
